...
int mult_655(polyveck C[5], polyvecl mat[6], polyvecl s1hats[5]){
	...
	//p1=  ( mat[0].vec[0] + s1hats[0].vec[1] ) * ( mat[0].vec[1] + s1hats[1].vec[0] )
	//p2=  ( mat[1].vec[0] + s1hats[0].vec[1] ) * ( mat[1].vec[1] + s1hats[1].vec[0] )
	//p3=  ( mat[2].vec[0] + s1hats[0].vec[1] ) * ( mat[2].vec[1] + s1hats[1].vec[0] )
	//p4=  ( mat[3].vec[0] + s1hats[0].vec[1] ) * ( mat[3].vec[1] + s1hats[1].vec[0] )
	//p5=  ( mat[4].vec[0] + s1hats[0].vec[1] ) * ( mat[4].vec[1] + s1hats[1].vec[0] )
	//p6=  ( mat[5].vec[0] + s1hats[0].vec[1] ) * ( mat[5].vec[1] + s1hats[1].vec[0] )
	...
	//p7=   ( mat[0].vec[0] + s1hats[0].vec[2] ) * ( mat[0].vec[2] + s1hats[2].vec[0] )
	//p8=   ( mat[1].vec[0] + s1hats[0].vec[2] ) * ( mat[1].vec[2] + s1hats[2].vec[0] )
	//p9=   ( mat[2].vec[0] + s1hats[0].vec[2] ) * ( mat[2].vec[2] + s1hats[2].vec[0] )
	//p10=  ( mat[3].vec[0] + s1hats[0].vec[2] ) * ( mat[3].vec[2] + s1hats[2].vec[0] )
	//p11=  ( mat[4].vec[0] + s1hats[0].vec[2] ) * ( mat[4].vec[2] + s1hats[2].vec[0] )
	//p12=  ( mat[5].vec[0] + s1hats[0].vec[2] ) * ( mat[5].vec[2] + s1hats[2].vec[0] )
	...
	//p13=  ( mat[0].vec[1] + s1hats[1].vec[2] ) * ( mat[0].vec[2] + s1hats[2].vec[1] )
	//p14=  ( mat[1].vec[1] + s1hats[1].vec[2] ) * ( mat[1].vec[2] + s1hats[2].vec[1] )
	//p15=  ( mat[2].vec[1] + s1hats[1].vec[2] ) * ( mat[2].vec[2] + s1hats[2].vec[1] )
	//p16=  ( mat[3].vec[1] + s1hats[1].vec[2] ) * ( mat[3].vec[2] + s1hats[2].vec[1] )
	//p17=  ( mat[4].vec[1] + s1hats[1].vec[2] ) * ( mat[4].vec[2] + s1hats[2].vec[1] )
	//p18=  ( mat[5].vec[1] + s1hats[1].vec[2] ) * ( mat[5].vec[2] + s1hats[2].vec[1] )
	...
	//p19=  mat[0].vec[0] * ( s1hats[0].vec[0] - s1hats[1].vec[0] - s1hats[2].vec[0] - mat[0].vec[1] - mat[0].vec[2] )
	//p20=  mat[1].vec[0] * ( s1hats[0].vec[0] - s1hats[1].vec[0] - s1hats[2].vec[0] - mat[1].vec[1] - mat[1].vec[2] )
	//p21=  mat[2].vec[0] * ( s1hats[0].vec[0] - s1hats[1].vec[0] - s1hats[2].vec[0] - mat[2].vec[1] - mat[2].vec[2] )
	//p22=  mat[3].vec[0] * ( s1hats[0].vec[0] - s1hats[1].vec[0] - s1hats[2].vec[0] - mat[3].vec[1] - mat[3].vec[2] )
	//p23=  mat[4].vec[0] * ( s1hats[0].vec[0] - s1hats[1].vec[0] - s1hats[2].vec[0] - mat[4].vec[1] - mat[4].vec[2] )
	//p24=  mat[5].vec[0] * ( s1hats[0].vec[0] - s1hats[1].vec[0] - s1hats[2].vec[0] - mat[5].vec[1] - mat[5].vec[2] )
	...
	//p25=  mat[0].vec[1] * ( s1hats[1].vec[1] - s1hats[0].vec[1] - s1hats[2].vec[1] - mat[0].vec[0] - mat[0].vec[2] )
	//p26=  mat[1].vec[1] * ( s1hats[1].vec[1] - s1hats[0].vec[1] - s1hats[2].vec[1] - mat[1].vec[0] - mat[1].vec[2] )
	//p27=  mat[2].vec[1] * ( s1hats[1].vec[1] - s1hats[0].vec[1] - s1hats[2].vec[1] - mat[2].vec[0] - mat[2].vec[2] )
	//p28=  mat[3].vec[1] * ( s1hats[1].vec[1] - s1hats[0].vec[1] - s1hats[2].vec[1] - mat[3].vec[0] - mat[3].vec[2] )
	//p29=  mat[4].vec[1] * ( s1hats[1].vec[1] - s1hats[0].vec[1] - s1hats[2].vec[1] - mat[4].vec[0] - mat[4].vec[2] )
	//p30=  mat[5].vec[1] * ( s1hats[1].vec[1] - s1hats[0].vec[1] - s1hats[2].vec[1] - mat[5].vec[0] - mat[5].vec[2] )
	...
	//p31=  mat[0].vec[2] * ( s1hats[2].vec[2] - s1hats[0].vec[2] - s1hats[1].vec[2] - mat[0].vec[0] - mat[0].vec[1] )
	//p32=  mat[1].vec[2] * ( s1hats[2].vec[2] - s1hats[0].vec[2] - s1hats[1].vec[2] - mat[1].vec[0] - mat[1].vec[1] )
	//p33=  mat[2].vec[2] * ( s1hats[2].vec[2] - s1hats[0].vec[2] - s1hats[1].vec[2] - mat[2].vec[0] - mat[2].vec[1] )
	//p34=  mat[3].vec[2] * ( s1hats[2].vec[2] - s1hats[0].vec[2] - s1hats[1].vec[2] - mat[3].vec[0] - mat[3].vec[1] )
	//p35=  mat[4].vec[2] * ( s1hats[2].vec[2] - s1hats[0].vec[2] - s1hats[1].vec[2] - mat[4].vec[0] - mat[4].vec[1] )
	//p36=  mat[5].vec[2] * ( s1hats[2].vec[2] - s1hats[0].vec[2] - s1hats[1].vec[2] - mat[5].vec[0] - mat[5].vec[1] )
	...
	//p37=  s1hats[1].vec[0]*s1hats[0].vec[1]
	//p38=  s1hats[2].vec[0]*s1hats[0].vec[2]
	//p39=  s1hats[2].vec[1]*s1hats[1].vec[2]
	...
	//p40=  ( mat[0].vec[0] + s1hats[0].vec[1] - s1hats[3].vec[1] ) * ( - mat[0].vec[1] - s1hats[1].vec[0] + s1hats[3].vec[0] - s1hats[4].vec[0] )
	//p41=  ( mat[1].vec[0] + s1hats[0].vec[1] - s1hats[3].vec[1] ) * ( - mat[1].vec[1] - s1hats[1].vec[0] + s1hats[3].vec[0] - s1hats[4].vec[0] )
	//p42=  ( mat[2].vec[0] + s1hats[0].vec[1] - s1hats[3].vec[1] ) * ( - mat[2].vec[1] - s1hats[1].vec[0] + s1hats[3].vec[0] - s1hats[4].vec[0] )
	//p43=  ( mat[3].vec[0] + s1hats[0].vec[1] - s1hats[3].vec[1] ) * ( - mat[3].vec[1] - s1hats[1].vec[0] + s1hats[3].vec[0] - s1hats[4].vec[0] )
	//p44=  ( mat[4].vec[0] + s1hats[0].vec[1] - s1hats[3].vec[1] ) * ( - mat[4].vec[1] - s1hats[1].vec[0] + s1hats[3].vec[0] - s1hats[4].vec[0] )
	//p45=  ( mat[5].vec[0] + s1hats[0].vec[1] - s1hats[3].vec[1] ) * ( - mat[5].vec[1] - s1hats[1].vec[0] + s1hats[3].vec[0] - s1hats[4].vec[0] )
	...
	//p46=  ( mat[0].vec[1] + s1hats[1].vec[2] + s1hats[3].vec[2] - s1hats[4].vec[2] ) * ( - mat[0].vec[2] - s1hats[2].vec[1] + s1hats[4].vec[1])
	//p47=  ( mat[1].vec[1] + s1hats[1].vec[2] + s1hats[3].vec[2] - s1hats[4].vec[2] ) * ( - mat[1].vec[2] - s1hats[2].vec[1] + s1hats[4].vec[1])
	//p48=  ( mat[2].vec[1] + s1hats[1].vec[2] + s1hats[3].vec[2] - s1hats[4].vec[2] ) * ( - mat[2].vec[2] - s1hats[2].vec[1] + s1hats[4].vec[1])
	//p49=  ( mat[3].vec[1] + s1hats[1].vec[2] + s1hats[3].vec[2] - s1hats[4].vec[2] ) * ( - mat[3].vec[2] - s1hats[2].vec[1] + s1hats[4].vec[1])
	//p50=  ( mat[4].vec[1] + s1hats[1].vec[2] + s1hats[3].vec[2] - s1hats[4].vec[2] ) * ( - mat[4].vec[2] - s1hats[2].vec[1] + s1hats[4].vec[1])
	//p51=  ( mat[5].vec[1] + s1hats[1].vec[2] + s1hats[3].vec[2] - s1hats[4].vec[2] ) * ( - mat[5].vec[2] - s1hats[2].vec[1] + s1hats[4].vec[1])
	...
	//p52=  ( mat[0].vec[0] + s1hats[0].vec[2] - s1hats[3].vec[2] ) * ( - mat[0].vec[2] - s1hats[2].vec[0] + s1hats[4].vec[0] )
	//p53=  ( mat[1].vec[0] + s1hats[0].vec[2] - s1hats[3].vec[2] ) * ( - mat[1].vec[2] - s1hats[2].vec[0] + s1hats[4].vec[0] )
	//p54=  ( mat[2].vec[0] + s1hats[0].vec[2] - s1hats[3].vec[2] ) * ( - mat[2].vec[2] - s1hats[2].vec[0] + s1hats[4].vec[0] )
	//p55=  ( mat[3].vec[0] + s1hats[0].vec[2] - s1hats[3].vec[2] ) * ( - mat[3].vec[2] - s1hats[2].vec[0] + s1hats[4].vec[0] )
	//p56=  ( mat[4].vec[0] + s1hats[0].vec[2] - s1hats[3].vec[2] ) * ( - mat[4].vec[2] - s1hats[2].vec[0] + s1hats[4].vec[0] )
	//p57=  ( mat[5].vec[0] + s1hats[0].vec[2] - s1hats[3].vec[2] ) * ( - mat[5].vec[2] - s1hats[2].vec[0] + s1hats[4].vec[0] )
	...
	//p58=  ( s1hats[0].vec[1] - s1hats[3].vec[1] ) * ( - s1hats[1].vec[0] + s1hats[3].vec[0] - s1hats[4].vec[0] ) 
	//p59=  ( s1hats[0].vec[2] - s1hats[3].vec[2] ) * ( - s1hats[2].vec[0] + s1hats[4].vec[0] )
	//p60=  ( s1hats[1].vec[2] + s1hats[3].vec[2] - s1hats[4].vec[2] ) * ( -s1hats[2].vec[1] + s1hats[4].vec[1] )
	...
	//p61=  mat[0].vec[3] * ( s1hats[0].vec[3] + mat[0].vec[4] )
	//p62=  mat[1].vec[3] * ( s1hats[0].vec[3] + mat[1].vec[4] )
	//p63=  mat[2].vec[3] * ( s1hats[0].vec[3] + mat[2].vec[4] )
	//p64=  mat[3].vec[3] * ( s1hats[0].vec[3] + mat[3].vec[4] )
	//p65=  mat[4].vec[3] * ( s1hats[0].vec[3] + mat[4].vec[4] )
	//p66=  mat[5].vec[3] * ( s1hats[0].vec[3] + mat[5].vec[4] )
	...
	//p67=  mat[0].vec[4] * ( s1hats[0].vec[4] - mat[0].vec[3] )
	//p68=  mat[1].vec[4] * ( s1hats[0].vec[4] - mat[1].vec[3] )
	//p69=  mat[2].vec[4] * ( s1hats[0].vec[4] - mat[2].vec[3] )
	//p70=  mat[3].vec[4] * ( s1hats[0].vec[4] - mat[3].vec[3] )
	//p71=  mat[4].vec[4] * ( s1hats[0].vec[4] - mat[4].vec[3] )
	//p72=  mat[5].vec[4] * ( s1hats[0].vec[4] - mat[5].vec[3] )
	...
	//p73=  ( mat[0].vec[3] + s1hats[1].vec[4] ) * ( mat[0].vec[4] + s1hats[0].vec[3] + s1hats[1].vec[3] ) 
	//p74=  ( mat[1].vec[3] + s1hats[1].vec[4] ) * ( mat[1].vec[4] + s1hats[0].vec[3] + s1hats[1].vec[3] )
	//p75=  ( mat[2].vec[3] + s1hats[1].vec[4] ) * ( mat[2].vec[4] + s1hats[0].vec[3] + s1hats[1].vec[3] )
	//p76=  ( mat[3].vec[3] + s1hats[1].vec[4] ) * ( mat[3].vec[4] + s1hats[0].vec[3] + s1hats[1].vec[3] )
	//p77=  ( mat[4].vec[3] + s1hats[1].vec[4] ) * ( mat[4].vec[4] + s1hats[0].vec[3] + s1hats[1].vec[3] )
	//p78=  ( mat[5].vec[3] + s1hats[1].vec[4] ) * ( mat[5].vec[4] + s1hats[0].vec[3] + s1hats[1].vec[3] )
	...
	//p79=  ( mat[0].vec[3] + s1hats[2].vec[4] ) * ( mat[0].vec[4] + s1hats[0].vec[3] + s1hats[2].vec[3] )
	//p80=  ( mat[1].vec[3] + s1hats[2].vec[4] ) * ( mat[1].vec[4] + s1hats[0].vec[3] + s1hats[2].vec[3] )
	//p81=  ( mat[2].vec[3] + s1hats[2].vec[4] ) * ( mat[2].vec[4] + s1hats[0].vec[3] + s1hats[2].vec[3] )
	//p82=  ( mat[3].vec[3] + s1hats[2].vec[4] ) * ( mat[3].vec[4] + s1hats[0].vec[3] + s1hats[2].vec[3] )
	//p83=  ( mat[4].vec[3] + s1hats[2].vec[4] ) * ( mat[4].vec[4] + s1hats[0].vec[3] + s1hats[2].vec[3] )
	//p84=  ( mat[5].vec[3] + s1hats[2].vec[4] ) * ( mat[5].vec[4] + s1hats[0].vec[3] + s1hats[2].vec[3] )
	...
	//p85=  ( mat[0].vec[3] + s1hats[3].vec[4] ) * ( mat[0].vec[4] + s1hats[0].vec[3] + s1hats[3].vec[3] )
	//p86=  ( mat[1].vec[3] + s1hats[3].vec[4] ) * ( mat[1].vec[4] + s1hats[0].vec[3] + s1hats[3].vec[3] )
	//p87=  ( mat[2].vec[3] + s1hats[3].vec[4] ) * ( mat[2].vec[4] + s1hats[0].vec[3] + s1hats[3].vec[3] )
	//p88=  ( mat[3].vec[3] + s1hats[3].vec[4] ) * ( mat[3].vec[4] + s1hats[0].vec[3] + s1hats[3].vec[3] )
	//p89=  ( mat[4].vec[3] + s1hats[3].vec[4] ) * ( mat[4].vec[4] + s1hats[0].vec[3] + s1hats[3].vec[3] )
	//p90=  ( mat[5].vec[3] + s1hats[3].vec[4] ) * ( mat[5].vec[4] + s1hats[0].vec[3] + s1hats[3].vec[3] )
	...
	//p91=  ( mat[0].vec[3] + s1hats[4].vec[4] ) * ( mat[0].vec[4] + s1hats[0].vec[3] + s1hats[4].vec[3] )
	//p92=  ( mat[1].vec[3] + s1hats[4].vec[4] ) * ( mat[1].vec[4] + s1hats[0].vec[3] + s1hats[4].vec[3] )
	//p93=  ( mat[2].vec[3] + s1hats[4].vec[4] ) * ( mat[2].vec[4] + s1hats[0].vec[3] + s1hats[4].vec[3] )
	//p94=  ( mat[3].vec[3] + s1hats[4].vec[4] ) * ( mat[3].vec[4] + s1hats[0].vec[3] + s1hats[4].vec[3] )
	//p95=  ( mat[4].vec[3] + s1hats[4].vec[4] ) * ( mat[4].vec[4] + s1hats[0].vec[3] + s1hats[4].vec[3] )
	//p96=  ( mat[5].vec[3] + s1hats[4].vec[4] ) * ( mat[5].vec[4] + s1hats[0].vec[3] + s1hats[4].vec[3] )
	...
	//p97=  s1hats[1].vec[4] * ( s1hats[0].vec[3] + s1hats[1].vec[3] )
	//p98=  s1hats[2].vec[4] * ( s1hats[0].vec[3] + s1hats[2].vec[3] )
	//p99=  s1hats[3].vec[4] * ( s1hats[0].vec[3] + s1hats[3].vec[3] )
	//p100= s1hats[4].vec[4] * ( s1hats[0].vec[3] + s1hats[4].vec[3] )
	...
	//C[0].vec[0]= p1 + p7  + p19 -p37 -p38 + p61 + p67
	//C[1].vec[0]= p2 + p8  + p20 -p37 -p38 + p62 + p68
	//C[2].vec[0]= p3 + p9  + p21 -p37 -p38 + p63 + p69
	//C[3].vec[0]= p4 + p10 + p22 -p37 -p38 + p64 + p70
	//C[4].vec[0]= p5 + p11 + p23 -p37 -p38 + p65 + p71
	//C[5].vec[0]= p6 + p12 + p24 -p37 -p38 + p66 + p72
	...
	//C[0].vec[1]= p1 + p13 + p25 - p37 - p39 + p73  - p61  - p97
	//C[1].vec[1]= p2 + p14 + p26 - p37 - p39 + p74  - p62  - p97
	//C[2].vec[1]= p3 + p15 + p27 - p37 - p39 + p75  - p63  - p97
	//C[3].vec[1]= p4 + p16 + p28 - p37 - p39 + p76  - p64  - p97
	//C[4].vec[1]= p5 + p17 + p29 - p37 - p39 + p77  - p65  - p97
	//C[5].vec[1]= p6 + p18 + p30 - p37 - p39 + p78  - p66  - p97
	...
	//C[0].vec[2]= p7  + p13 + p31 - p38 - p39 + p79  - p61  - p98
	//C[1].vec[2]= p8  + p14 + p32 - p38 - p39 + p80  - p62  - p98
	//C[2].vec[2]= p9  + p15 + p33 - p38 - p39 + p81  - p63  - p98
	//C[3].vec[2]= p10 + p16 + p34 - p38 - p39 + p82  - p64  - p98
	//C[4].vec[2]= p11 + p17 + p35 - p38 - p39 + p83  - p65  - p98
	//C[5].vec[2]= p12 + p18 + p36 - p38 - p39 + p84  - p66  - p98
	...
	//C[0].vec[3]= p1 + p7  + p40  + p52 - p37 - p38 - p58 - p59 + p85 - p61 - p99
	//C[1].vec[3]= p2 + p8  + p41  + p53 - p37 - p38 - p58 - p59 + p86 - p62 - p99
	//C[2].vec[3]= p3 + p9  + p42  + p54 - p37 - p38 - p58 - p59 + p87 - p63 - p99
	//C[3].vec[3]= p4 + p10 + p43  + p55 - p37 - p38 - p58 - p59 + p88 - p64 - p99
	//C[4].vec[3]= p5 + p11 + p44  + p56 - p37 - p38 - p58 - p59 + p89 - p65 - p99
	//C[5].vec[3]= p6 + p12 + p45  + p57 - p37 - p38 - p58 - p59 + p90 - p66 - p99
	...
	//C[0].vec[4]= p7  + p13 + p46 + p52 - p38 - p39 - p59 - p60 + p91 - p61 - p100
	//C[1].vec[4]= p8  + p14 + p47 + p53 - p38 - p39 - p59 - p60 + p92 - p62 - p100
	//C[2].vec[4]= p9  + p15 + p48 + p54 - p38 - p39 - p59 - p60 + p93 - p63 - p100
	//C[3].vec[4]= p10 + p16 + p49 + p55 - p38 - p39 - p59 - p60 + p94 - p64 - p100
	//C[4].vec[4]= p11 + p17 + p50 + p56 - p38 - p39 - p59 - p60 + p95 - p65 - p100
	//C[5].vec[4]= p12 + p18 + p51 + p57 - p38 - p39 - p59 - p60 + p96 - p66 - p100
